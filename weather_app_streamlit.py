...
st.write("https://www.linkedin.com/in/adam-eccles-616b1427b/")

unit = st.selectbox("Select temperature unit:", ["Celsius", "Fahrenheit"])
units_param = "metric" if unit == "Celsius" else "imperial"
unit_symbol = "°C" if unit == "Celsius" else "°F"

location = st.text_input("Enter a city (London), landmark (Eiffel Tower) or GPS coordinates (lat,lon):")
...
if st.button("Get Weather") and location:
    try:
        ...
        with left_col:
            ...
            # One Call API - UV Index only (no alerts)
